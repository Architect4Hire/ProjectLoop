...
/// </summary>
public sealed class ApprovalRequestedNotificationConsumer : IApprovalRequestedNotificationConsumer
{
    private readonly IApprovalRequestedNotificationConsumerTransaction _transaction;
    private readonly TimeProvider _timeProvider;

    public ApprovalRequestedNotificationConsumer(
        IApprovalRequestedNotificationConsumerTransaction transaction,
