...
public sealed class ApprovalRejectedNotificationConsumerTransaction : IApprovalRejectedNotificationConsumerTransaction
{
    private const string NotificationType = "ApprovalRejected";

    private readonly NotificationsDbContext _dbContext;
    private readonly IEmailNotificationSender _sender;

    public ApprovalRejectedNotificationConsumerTransaction(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (alreadyProcessed)
        {
            ...
            // ApprovalRejected delivery from ever producing a duplicate
            // logical notification.
            return;
        }

        var notification = ApprovalRejectedNotificationMapper.Map(envelope.Data);
