...
public class ApprovalGrantedAuditConsumerTransactionTests
{
    ...
    public async Task ExecuteAsync_First_Delivery_Appends_AuditRecord_And_Records_Inbox()
    {
        ...
        var transaction = new ApprovalGrantedAuditConsumerTransaction(dbContext, new AuditRecordRepository(dbContext));
