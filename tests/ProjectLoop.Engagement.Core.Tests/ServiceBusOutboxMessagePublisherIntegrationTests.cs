...
{
    private const string ConnectionStringEnvironmentVariable = "ENGAGEMENT_SERVICEBUS_TEST_CONNECTION_STRING";
    private const string EntityNameEnvironmentVariable = "ENGAGEMENT_SERVICEBUS_TEST_ENTITY_NAME";
    ...
    public async Task PublishAsync_Sends_The_Outbox_Row_To_The_Configured_Entity()
    {
        ...
        var outboxMessage = new OutboxMessage
        {
            ...
            EventVersion = 1,
            Payload = "{\"eventType\":\"MilestoneCompleted\"}",
